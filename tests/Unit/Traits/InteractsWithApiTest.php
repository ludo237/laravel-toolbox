...
class InteractsWithApiTest extends TestCase
{
     ...
     * @test
     *
     * @covers \Ludo237\Traits\Traits\InteractsWithApi::apiField
     */
     ...
     * @test
     *
     * @covers \Ludo237\Traits\Traits\InteractsWithApi::bootInteractsWithApi
     */
     ...
     * @test
     *
     * @covers \Ludo237\Traits\Traits\InteractsWithApi::apiKey
     */
     ...
     * @test
     *
     * @covers \Ludo237\Traits\Traits\InteractsWithApi::hasApiKey
     * @covers \Ludo237\Traits\Traits\InteractsWithApi::doesNotHaveApiKey
     */
