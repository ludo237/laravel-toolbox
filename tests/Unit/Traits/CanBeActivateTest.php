...
class CanBeActivateTest extends TestCase
{
     ...
     * @test
     *
     * @covers \Ludo237\Traits\Traits\CanBeActivate::activateAtField
     */
     ...
     * @test
     *
     * @covers \Ludo237\Traits\Traits\CanBeActivate::isActive
     * @covers \Ludo237\Traits\Traits\CanBeActivate::isNotActive
     */
     ...
     * @test
     *
     * @covers \Ludo237\Traits\Traits\CanBeActivate::activate
     */
     ...
     * @test
     *
     * @covers \Ludo237\Traits\Traits\CanBeActivate::deactivate
     */
