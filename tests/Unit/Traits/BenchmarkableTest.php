...
class BenchmarkableTest extends TestCase
{
     ...
     * @test
     *
     * @covers \Ludo237\Traits\Traits\Benchmarkable::startTime
     * @covers \Ludo237\Traits\Traits\Benchmarkable::endTime
     * @covers \Ludo237\Traits\Traits\Benchmarkable::getEndTime
     */
